                    ...
                    <md-input-container flex="50" class="md-block" >
                        ...
                        <md-select ng-model="subscriber.selectedCity"
                            ...
                            <md-optgroup label="city">
                                ...
                                filter:searchTerm">{{thecity.name}}</md-option>
                            </md-optgroup>
                        </md-select>
                    </md-input-container>

                <div style="margin-top:40px;">
                    <md-button type="submit" ng-disabled="subscribeForm.$invalid" ng-click="" style="margin:auto; display:block">Send</md-button>
                </div>
